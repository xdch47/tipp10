...
QString ErrorMessage::getErrorText(int number)
{
    ...
    case ERR_SQL_DB_APP_COPY:
        errorText = tr("Die Benutzer-Datenbank konnte nicht in "
                       "Ihrem HOME-Verzeichnis angelegt werden. Eventell "
                       "fehlen die Schreibrechte.\n"
                       "Es wird nun versucht, die Original-Datenbank im "
                       "Programmverzeichnis zu verwenden.\n\n"
                       "Den Verzeichnispfad zur Datenbank koennen Sie "
    ...
    case ERR_SQL_DB_USER_COPY:
        errorText = tr("Die Benutzer-Datenbank konnte nicht im "
                       ...
                       "Es wird nun versucht, eine Datenbank in Ihrem "
                       "HOME-Verzeichnis anzulegen.\n\n"
                       "Den Verzeichnispfad zur Datenbank koennen Sie "
                       "anschliessend in den "
                       "Einstellungen veraendern.\n");
        break;
    ...
    case ERR_USER_LESSONS_FLUSH:
        errorText = tr("Die Benutzertabelle mit den Lektionendaten kann nicht\n"
                       "geleert werden.\nSQL-Statement fehlgeschlagen.");
        break;
    case ERR_USER_ERRORS_FLUSH:
        errorText = tr("Die Benutzertabelle mit den Fehlerdaten kann nicht\n"
                       "geleert werden.\nSQL-Statement fehlgeschlagen.");
        break;
    ...
    case ERR_LESSONS_UPDATE:
        errorText
            = tr("Die Lektion konnte nicht aktualisiert werden, weil kein\n"
                 "Zugriff auf die Datenbank moeglich ist.\n\n"
                 "Falls dieses Problem erst auftrat, nachem der "
                 "Schreibtrainer\n"
                 "zuvor einige Zeit anstandslos lief, ist voraussichtlich die\n"
                 "Datenbank beschaedigt worden (z.B. durch einen Absturz des\n"
                 "Computers).\n"
                 "Um zu ueberpruefen ob die Datenbank beschaedigt wurde, "
                 "koennen\n"
                 "Sie die Datenbank-Datei testweise einmal umbenennen und die\n"
                 "Software dann neu starten (es sollte dann auomatisch eine\n"
                 "neue, leere Datenbank angelegt werden). Den Pfad zur "
                 "Datenbank\n"
                 "\"")
            + APP_USER_DB
            + tr("\" koennen Sie den Grundeinstellungen entnehmen.\n\n"
                 "Wenn dieses Problem gleich nach dem ersten Start der "
                 "Software\n"
    ...
    case ERR_USER_ERRORS_REFRESH:
        errorText
            = tr("Die Benutzertabelle mit den Fehlerdaten konnte nicht\n"
    ...
    case ERR_USER_LESSONS_REFRESH:
        errorText
            = tr("Die Benutzertabelle mit den Lektionendaten konnte nicht\n"
                 "aktualisiert werden, weil kein Zugriff auf die Datenbank\n"
                 "moeglich ist.\n\n"
                 "Falls dieses Problem erst auftrat, nachem der "
                 "Schreibtrainer\n"
    ...
    case ERR_USER_IMPORT_READ:
        errorText
            = tr("Die Datei konnte leider nicht importiert "
                 "werden.\n"
    ...
    case ERR_USER_EXPORT_WRITE:
        errorText = tr("Die Datei konnte leider nicht exportiert "
                       "werden.\n"
                       "Bitte ueberpruefen Sie, ob es sich um eine "
                       "beschreibbare Textdatei "
                       "handelt.\n");
        break;
