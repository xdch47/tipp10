...
void IllustrationDialog::createContent()
{
    ...
    content = ""
        ...
        + "</b>"
          ...
          "</div>"
          "<div style=\"margin-top:16px;\">"
        + tr("TIPP10 ist ein kostenloser 10-Finger-Schreibtrainer fuer "
             "Windows, Mac OS "
             "und Linux. Die Software arbeitet intelligent - Schriftzeichen, "
             "die haeufig "
             "falsch getippt werden, werden auch sofort haeufiger diktiert. "
             "So laesst sich das Zehnfingersystem schnell und effizient "
             "erlernen.")
        + "</div>"
        ...
        + tr("1. Die Finger nehmen zunaechst die Grundstellung ein "
             ...
             "Nach jedem Tippen einer Taste kehren die Finger in die "
             "Grundstellung "
             "zurueck.")
        + "</div>"
          "<div style=\"margin-top:16px;\">"
        ...
        + "_illustration.png\">"
          "</div>"
          "<div style=\"margin-top:16px;\">"
        + tr("2. Nehmen Sie eine aufrechte Haltung ein und vermeiden Sie es in "
             "jedem "
             "Fall auf die Tastatur zu sehen. Ihr Blick sollte stets auf den "
             "Bildschirm gerichtet sein.")
        + "</div>"
          "<div style=\"margin-top:10px;\">"
        + tr("3. Legen Sie die Oberarme am Koerper an und lassen Sie die "
             "Schultern "
             "haengen. Die Unterarme bilden einen rechten Winkel zu den "
             "Oberarmen. "
             "Legen Sie die Handgelenke nicht ab und lassen Sie sie nicht "
             "durchhaengen.")
        + "</div>"
          "<div style=\"margin-top:10px;\">"
        ...
        + "</div>"
          "<div style=\"margin-top:10px;\">"
        + tr("5. Versuchen Sie moeglichst fehlerfrei zu tippen. Es ist "
             "deutlich ineffizienter "
             "schnell zu tippen, wenn Sie dabei viele Fehler machen.")
        + "</div>"
          "<div style=\"margin-top:10px;\">"
        + tr("6. Einmal mit dem Zehnfingersystem angefangen, sollten Sie es "
             "tunlichst "
             "vermeiden wieder zu Ihrem \"alten System\" zurueck zu wechseln "
             "(auch "
             "wenn es mal schnell gehen muss).")
        + "</div>"
          "<div style=\"margin-top:26px;\">"
        + tr(
            "Bei Fragen rund um die Bedienung der Software rufen Sie bitte die "
            "Hilfe auf oder besuchen Sie die Internetseite")
        + " <a href=\"http://www.tipp10.de\">http://www.tipp10.de</a>. "
        + tr("Dort finden Sie auch praktische Tipps und "
