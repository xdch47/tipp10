...
void EvaluationWidget::createComparisonTable()
{
    ...
    content = ""
        ...
        + tr("Beachten Sie, dass langsames Tippen ohne Fehler bessere "
             "Bewertungen hervorruft, als schnelles Tippen mit vielen Fehlern!")
        + "</div>"
          "<div style=\"margin-top:8px;font-size:10px;\">"
          "<table width=\"100%\" border=\"0.5\"cellspacing=\"0\" "
          "cellpadding=\"1\" "
          "style=\"border-color:#444444;border-style:solid;\">"
          "<tr>"
          "<td bgcolor=\"#DDDDDD\">"
          "<b>"
        + tr("Bewertung")
        ...
        + ""
          ...
          "<td bgcolor=\"#FFFFFF\">"
          "20 "
        + tr("A/min und") + " 16 " + tr("Fehler in") + " 5 " + tr("Minuten")
        + ""
          "</td>"
        ...
        + ""
          ...
          "<td bgcolor=\"#FFFFFF\">"
          "20 "
        + tr("A/min und") + " 2 " + tr("Fehler in") + " 5 " + tr("Minuten")
        + ""
          "</td>"
          "</tr>"
          "<tr>"
        ...
        + ""
          ...
          "<td bgcolor=\"#FFFFFF\">"
          "20 "
        + tr("A/min und") + " 0 " + tr("Fehler in") + " 5 " + tr("Minuten")
        + ""
          "</td>"
          "</tr>"
          "<tr>"
        ...
        + ""
          ...
          "<td bgcolor=\"#FFFFFF\">"
          "100 "
        + tr("A/min und") + " 3 " + tr("Fehler in") + " 5 " + tr("Minuten")
        + ""
          "</td>"
          "<td bgcolor=\"#FFFFFF\" rowspan=\"3\" valign=\"bottom\">"
          ""
        ...
        + ""
          ...
          "<td bgcolor=\"#FFFFFF\">"
          "200 "
        + tr("A/min und") + " 1 " + tr("Fehler in") + " 5 " + tr("Minuten")
        + ""
          "</td>"
          "</tr>"
          "<tr>"
